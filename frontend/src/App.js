...
function Login() {
  ...
  return (
    <div>
      <h2>
        You are logged in! Now check out <Link to="/hello/">/hello/</Link>
      </h2>
    </div>
  );
}
...
function Logout() {
  ...
  return (
    <div>
      <h2>
        You are logged out! Now check out <Link to="/hello/">/hello/</Link>
      </h2>
    </div>
  );
}
  ...
  if (error) {
    return (
      <div>
        <h3>
          {" "}
          Error: either flask is not running, or you must{" "}
